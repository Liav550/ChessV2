...
class AITest {
    ...
    public void testScholarsMate(){
        ...
        MoveTransition t4 = t3.getTransitionBoard().getCurrentPlayer().makeMove(Move.MoveFactory.createMove(t3.getTransitionBoard(),
                BoardUtils.getIndexFromNotation("b8"), BoardUtils.getIndexFromNotation("c6")));
        assertTrue(t4.getMoveStatus().isDone());

        MoveTransition t5 = t4.getTransitionBoard().getCurrentPlayer().makeMove(Move.MoveFactory.createMove(t4.getTransitionBoard(),
                BoardUtils.getIndexFromNotation("d1"), BoardUtils.getIndexFromNotation("f3")));
        assertTrue(t5.getMoveStatus().isDone());

        MoveTransition t6 = t5.getTransitionBoard().getCurrentPlayer().makeMove(Move.MoveFactory.createMove(t5.getTransitionBoard(),
        ...
        Move bestMove = Move.MoveFactory.createMove(t6.getTransitionBoard(), BoardUtils.getIndexFromNotation("f3"),
